...
madrid = pd.read_csv('madrid_clean.csv')
...
#Table Airbnb / Madrid
    ...
    with tab_plots2:
        ...
        st.image('correlation.png', width=1000)

    #Table neighbourhood_group
    tab_plots2 = tabs2[1]
    with tab_plots2:
        
        st.image('neighbourhood_group.png', width=1000)

    #Table neighbourhood
    tab_plots2 = tabs2[2]
    with tab_plots2:
        
        st.image('neighbourhood.png', width=1500)

    #Table room type
    tab_plots2 = tabs2[3]
    with tab_plots2:
        
        st.image('room_type.png', width=1000)

    #Table NEIGHBOURGROUP AND AVAILABILITY
    tab_plots2 = tabs2[4]
    with tab_plots2:
        
        st.image('neigh_avail.png')
    ...
    with tab_plots3:
        ...
        st.image('map_neighgroup.png', width=1000)
    
    #Table NEIGHBOURHOOD GROUP
    tab_plots3 = tabs3[1]
    with tab_plots3:
        
        st.image('map_neighbourhood.png', width=1000)

    #Table ROOM TYPE
    tab_plots3 = tabs3[2]
    with tab_plots3:
        
        st.image('map_roomtype.png', width=1000)

    #Table AVAILABILITY
    tab_plots3 = tabs3[3]
    with tab_plots3:
        
        st.image('map_avail.png', width=1000)

else:
    # Word Cloud
    st.title('Word Cloud')
    st.image('WordCloud.png', width=1000)
